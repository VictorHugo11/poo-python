...
class Aluno(Pessoa):
    ...
    def incluir_triunfo(self, quantidade):
        self.__triunfo += quantidade

    def incluir_mau_feitos(self, quantidade):
        self.__mau_feitos += quantidade

    def get_triunfo(self):
        return self.__triunfo
...
class Torneio:
    ...
    def marca_ponto(self, casa, quantidade):
        if casa == self.casa1:
